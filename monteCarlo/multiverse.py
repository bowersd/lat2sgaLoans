...
phonotactics = [#what to look for in Latin
        ...
        re.compile('(^[^AEIOUaeiou]*(((e|o)[^AEIOUaeiou]?[iuIU])|((i|u)[^AEIOUaeiou]*[aoAO])))'), #multisyllable affection -> non-low short vowel in initial syll followed by V with opposite value of [HIGH] (weakly? correlated with trisyllables)
