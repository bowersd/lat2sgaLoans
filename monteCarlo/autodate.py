...
triggers = [#what to look for in Latin
        ...
        re.compile('[aeiou]_*(?=[dg][^rln])'), #compensatory lengthening (shortening handled in procs_kludge() to avoid lookbehind limits)
...
processes = [ #slightly refined regexen to apply to latin, paired with dicts to check if the rule applied or not. these need to be alignment-proof (overlook _)
        ...
        ((re.compile('[aeiou]_*(?=[dg][rln])'), {"a":"A", "e":"E", "i":"I", "o":"O", "u":"U"},1), (re.compile('[aeiou]_*(?=[dg][^rln])'), {"a":"a", "e":"e", "i":"i", "o":"o", "u":"u"},0)), #compensatory lengthening (shortening handled in procs_kludge() to avoid lookbehind limits) Is there data on failure to lengthen??
